...
整理注（2026-09-23）：下文是历史实验进展，不代表当前运行状态。完整证据已冻结到 [根 Ara 档案](../../archives/ara/2026-09-23-poc-batch/README.md)，原 snapshot 保留为本地副本、不再重复提交。阶段性判断请结合 bugs.md 后续修订及合法配置复验阅读。
